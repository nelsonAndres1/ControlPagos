...
const routes: Routes = [
  ...
  { path: 'notificaciones', component: NotificacionesComponent, canActivate: [IdentityGuard, MenuPermissionGuard], data: { menuKey: 'notificaciones' } },
  { path: 'principal', component: PrincipalComponent, canActivate: [IdentityGuard, MenuPermissionGuard], data: { menuKey: 'principal' } },
  { path: 'logout/:sure', component: LoginComponent, canActivate: [IdentityGuard] },
  { path: 'teso10', component: Teso10Component, canActivate: [IdentityGuard, MenuPermissionGuard], data: { menuKey: 'teso13_create' } },
  ...
  { path: 'editar_teso12', component: EditarTeso12Component, canActivate: [IdentityGuard, MenuPermissionGuard], data: { menuKey: 'editar_soportes_catalogo' } },
  { path: 'teso13', component: Teso13Component, canActivate: [IdentityGuard, MenuPermissionGuard], data: { menuKey: 'teso13_create' } },
  { path: 'editar_teso13', component: Teso13editarComponent, canActivate: [IdentityGuard, MenuPermissionGuard], data: { menuKey: 'teso13_edit' } },
  { path: 'EditarSoportes', component: EditarSoportesComponent, canActivate: [IdentityGuard, MenuPermissionGuard], data: { menuKey: 'teso13_supports_edit' } },
  { path: 'teso14', component: Teso14Component, canActivate: [IdentityGuard, MenuPermissionGuard], data: { menuKey: 'vincular_pagos_soportes' } },
  { path: 'teso114', component: Teso114Component, canActivate: [IdentityGuard] },
  { path: 'teso15', component: Teso15Component, canActivate: [IdentityGuard, MenuPermissionGuard], data: { menuKey: 'teso15_status' } },
  { path: 'teso16', component: Teso16Component, canActivate: [IdentityGuard] },
  { path: 'teso17', component: Teso17Component, canActivate: [IdentityGuard, MenuPermissionGuard], data: { menuKey: 'teso17_status_change' } },
  ...
  { path: 'teso110', component: Teso110Component, canActivate: [IdentityGuard, MenuPermissionGuard], data: { menuKey: 'tipos_pago' } },
  { path: 'teso112', component: Teso112Component, canActivate: [IdentityGuard, MenuPermissionGuard], data: { menuKey: 'tipos_soporte' } },
  ...
  { path: 'reporte', component: ReportesComponent, canActivate: [IdentityGuard, MenuPermissionGuard], data: { menuKey: 'reportes' } },
  { path: 'reportes_dinamicos', component: ReportesDinamicosComponent, canActivate: [IdentityGuard, MenuPermissionGuard], data: { menuKey: 'reportes_dinamicos' } },
  ...
  { path: 'teso22', component: Teso22Component, canActivate: [IdentityGuard, MenuPermissionGuard], data: { menuKey: 'arbol_pagos' } },
  { path: 'teso117/super', component: Teso117SuperComponent, canActivate: [IdentityGuard] },
  { path: 'teso23', component: Teso23Component, canActivate: [IdentityGuard, MenuPermissionGuard], data: { menuKey: 'permisos_legacy' } },
  { path: 'teso15Nit', component: Teso15NitComponent, canActivate: [IdentityGuard, MenuPermissionGuard], data: { menuKey: 'teso15_nit' } },
  { path: 'PasosGenerales', component: PasosGeneralesComponent, canActivate: [IdentityGuard, MenuPermissionGuard], data: { menuKey: 'pasos_generales' } },
  { path: 'tablero', component: TableroTeso13Component, canActivate: [IdentityGuard, MenuPermissionGuard], data: { menuKey: 'tablero' } },
