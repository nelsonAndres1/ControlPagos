...
export class Teso13Component implements OnInit {
    ...
    siCDPno() {
        if (this.banderaCDP == true) {
            this.banderaCDP = false;
            this.bd1 = true;
        } else {
            this.banderaCDP = true;
            this.bd1 = false;
        }
    }
                ...
                if (this.banderaCDP == true) {
                    this._userService.valorCDP(new Conta71(this.cdp_marca, this.cdp_documento, this.cdp_ano, this.nit)).subscribe(response => {
                        ...
                        if (response > parseInt(this.teso13.valor)) {
                            ...
                            console.log("teso13 ahhhhh ");
                            console.log(this.teso13);
                            console.log("arrayD ahhhhh");
                            console.log(arrayD);
                            const navigationExtras: NavigationExtras = {
                                queryParams: {
                    ...
                    this.teso13.cdp_documento="0"
                    this.teso13.cdp_marca="OP";
                    this.teso13.numcuo = 1;
                    var arrayD = [];
                    arrayD.push(this.num, this.tpago, this.nit_nombre, this.codcen_nombre, this.coddep_nombre, 'OP', '0', '0', this.teso13.nit);
                    console.log("teso13 ahhhhh ");
                    console.log(this.teso13);
                    console.log("arrayD ahhhhh");
                    console.log(arrayD);
